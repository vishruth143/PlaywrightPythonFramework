# Tutorial: Launching Chrome Browser with Playwright
# ---------------------------------------------------
# This script demonstrates how to launch Google Chrome using Playwright
# and perform a basic search on Google.
#
# Key Concepts:
#   - sync_playwright()               : Context manager that starts the Playwright engine (synchronous API).
#   - playwright.chromium.launch()    : Launches a Chromium (Chrome) browser instance.
...
#
# In this example, the script opens Google in Chrome, searches for "Automation step by step",
